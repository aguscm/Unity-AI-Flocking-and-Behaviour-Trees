...
namespace BBUnity.Actions
{
    ...
    /// </summary>
    [Action("Custom/MoveCloseToGameObject")]
    [Help("Moves the game object towards a given target by using a NavMeshAgent")]
    public class MoveCloseToGameObject : GOAction
    {
        ...
        [InParam("distanceToObjectUntilSuccess")]
        [Help("Determines the distance to the object until success")]
        public float distanceToObjectUntilSuccess;
        ...
        public override TaskStatus OnUpdate()
        {
            ...
            if (!navAgent.pathPending && navAgent.remainingDistance - navAgent.stoppingDistance <= distanceToObjectUntilSuccess)
